...
-- **세 가지로 채운다.**
--
--   (1) 쌍둥이 161곳 — 한 건물에서 고속·시외를 함께 취급하는 종합터미널이 많아 같은 곳이 두 목록에
--       다른 이름으로 올라 있다. 이미 검증한 시외 좌표를 그대로 쓴다. 외부 호출 0.
--       **괄호 안 한정어까지 맞춰야 한다** — 안 맞추면 `광주(유·스퀘어)`(광주광역시)에 `광주(경기)` 좌표가
--       붙는다. 270km 밖이다.
--
--   (2) 지오코딩 83곳 — **이름이 아니라 분류로 가른다.** '터미널' 은 물류·택배·편의점 상호에도
--       쓰는 말이라 이름만으로는 못 거른다. 카카오 category_name 이 버스 계열일 때만 받는다:
--         교통,수송 > 교통시설 > 고속,시외버스터미널
--         교통,수송 > 교통시설 > 고속,시외버스정류장
--       거르는 것만이 아니다 — `동광양터미널` 은 첫 결과가 GS25 편의점이었는데, 분류로 거르니
--       **중마버스터미널**(정답)이 잡힌다. `동대구` 도 퀵서비스에서 동대구터미널로 바뀐다.
--
--   (3) 손으로 바로잡은 3곳 — 자동 규칙이 같은 좌표로 묶었으나 실제로는 다른 곳이었다.
...
-- 틀린 좌표는 resolver 가 엉뚱한 곳을 답하게 하지만, 빈 좌표는 최근접 탐색에서 빠질 뿐이다.
...
-- 낙산 — 낙산버스터미널 · 강원특별자치도 양양군 강현면 동해대로 3087 · 고속,시외버스정류장
UPDATE bus_terminal SET lat = 38.11766526, lng = 128.62827945 WHERE code = 'NAEK243';
-- 내서 — 내서고속버스터미널 · 경남 창원시 마산회원구 내서읍 유통단지로 35 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.25573980, lng = 128.51317494 WHERE code = 'NAEK706';
-- 대산 — 대산버스터미널 · 충남 서산시 대산읍 정자동4로 8 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 36.93913564, lng = 126.43056351 WHERE code = 'NAEK385';
-- 대신 — 대신터미널 · 경기 여주시 대신면 여양로 1480 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 37.37353939, lng = 127.58398125 WHERE code = 'NAEK932';
-- 대전도룡 — 도룡동고속시외무인정류소 · 대전 유성구 도룡동 401-2 · 고속,시외버스정류장
UPDATE bus_terminal SET lat = 36.38872397, lng = 127.37729778 WHERE code = 'NAEK307';
-- 대전청사(샘머리) — 대전청사고속버스둔산정류장 · 대전 서구 둔산동 908 · 고속,시외버스정류장
UPDATE bus_terminal SET lat = 36.36141363, lng = 127.39058525 WHERE code = 'NAEK305';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK800';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK801';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK802';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK803';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK804';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK806';
-- 동대구 — 동대구터미널 · 대구 동구 동부로 149 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.87798596, lng = 128.63030850 WHERE code = 'NAEK808';
-- 동래 — 동래시외버스정류소 · 부산 동래구 중앙대로1325번길 24 · 고속,시외버스정류장
UPDATE bus_terminal SET lat = 35.20572087, lng = 129.07656883 WHERE code = 'NAEK887';
-- 동해 — 동해시종합버스터미널 · 강원특별자치도 동해시 동해대로 5443 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 37.52770657, lng = 129.10404236 WHERE code = 'NAEK210';
-- 밀양 — 밀양버스터미널 · 경남 밀양시 북성로 7 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.49880937, lng = 128.74368681 WHERE code = 'NAEK750';
-- 범계 — 범계공항리무진버스정류소 · 경기 안양시 동안구 시민대로159번길 25 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 37.39086285, lng = 126.94790409 WHERE code = 'NAEK481';
-- 봉화 — 봉화공용정류장 · 경북 봉화군 봉화읍 봉화로 1153 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 36.89124433, lng = 128.73600071 WHERE code = 'NAEK858';
-- 부산 — 부산종합버스터미널 · 부산 금정구 중앙대로 2238 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.28477323, lng = 129.09547241 WHERE code = 'NAEK700';
-- 부산사상 — 부산서부버스터미널 · 부산 사상구 사상로 201 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.16323947, lng = 128.98252543 WHERE code = 'NAEK703';
-- 부산시외 — 부산종합버스터미널 · 부산 금정구 중앙대로 2238 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.28477323, lng = 129.09547241 WHERE code = 'NAEK701';
-- 삼호 — 삼호터미널 · 전남광주통합특별시 영암군 삼호읍 용앙리 1657-6 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 34.75442731, lng = 126.45149197 WHERE code = 'NAEK591';
-- 서대구 — 서대구고속버스터미널 · 대구 북구 팔달로 103 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 35.89026310, lng = 128.56141474 WHERE code = 'NAEK805';
-- 서천 — 서천버스터미널 · 충남 서천군 서천읍 서천로 31 · 고속,시외버스터미널
UPDATE bus_terminal SET lat = 36.07548625, lng = 126.69585963 WHERE code = 'NAEK384';
-- 서충주 — 서충주고속버스정류소 · 충북 충주시 중앙탑면 용전리 228-11 · 고속,시외버스정류장
...
-- 선산 — 선산시외버스터미널 · 경북 구미시 선산읍 선산대로 1408 · 고속,시외버스터미널
...
-- 횡성시외 — 횡성시외버스터미널 · 강원특별자치도 횡성군 횡성읍 횡성로 377 · 고속,시외버스터미널
