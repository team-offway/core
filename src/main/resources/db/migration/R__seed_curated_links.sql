...
-- 내일로 패스. 29세 이하가 정해진 기간 동안 열차를 자유롭게 타는 상품이다.
-- **지역 칩이 아니라 여기 있는 이유**는 전국 어디서나 같은 조건이기 때문이다 — 89곳 전부에 같은
-- 뱃지를 다는 것은 "이 지역이라서" 를 말하지 못한다.
(6, '내일로 패스', '청년 기차 자유여행',
 '만 29세 이하가 정해진 기간 동안 열차를 자유롭게 타는 코레일 패스.',
 'https://www.korail.com/tour/freeTravel/railro/passIntro', NULL,
 NULL, NULL, TRUE, 'HOME,COURSE', 60, TRUE),

-- 한국관광 100선. 한국관광공사가 2년마다 뽑는 목록이라 우리 89곳도 여럿 들어 있다.
-- 코스 화면에는 안 켠다 — 이미 코스가 짜인 자리에서 다른 여행지를 권할 이유가 없다.
(7, '한국관광 100선', '가볼 만한 곳',
 '한국관광공사가 2년마다 선정하는 대표 여행지 목록.',
 'https://korean.visitkorea.or.kr/list/best_list.do', NULL,
 NULL, NULL, TRUE, 'HOME,REGION', 70, TRUE),
