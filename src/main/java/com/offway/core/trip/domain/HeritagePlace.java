...
public class HeritagePlace {
    ...
    /**
     * 대표 이미지. 96% 가 채워지지만 없는 것이 있어 null 을 허용한다.
     *
    ...
    /** 국가유산청이 주는 소개 글. 98% 가 채워진다 — 인허가 장소에는 없던 것이다. */
    @Lob
