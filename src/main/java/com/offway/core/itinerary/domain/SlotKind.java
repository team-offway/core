...
public enum SlotKind {
    ...
    /**
     * 카페 — <b>밥 다음</b>에 한 칸(#522).
     *
     * <p>예전에는 카페가 끼니 자리에 들어갔다. TourAPI 음식점 대분류({@code FD})에 카페({@code FD05})가
     * 섞여 있어서인데, 실제로 <b>태안 1일차 점심이 카페</b>로 나갔다. 반대로 인허가 카페 15,619건은
     * 한 건도 안 쓰였다.
     *
     * <p>끼니와 갈라 두면 둘 다 제자리를 찾는다 — 밥은 밥집이 되고, 카페는 밥 뒤에 붙는다.
     */
    CAFE("카페", true, true),
