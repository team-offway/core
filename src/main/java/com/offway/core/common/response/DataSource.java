...
public enum DataSource {
    ...
    /**
     * 전국문화축제표준데이터(#433) — 지자체 229곳이 같은 스키마로 올린 것을 <b>공공데이터포털이 매월 초
     * 병합</b>해 전국 단위로 낸다.
     *
     * <p>기관명을 "행정안전부" 로 적지 않는다. 이 값의 출처는 각 지자체이고 포털은 병합·배포를 맡을 뿐이라,
     * 화면에 한 기관을 지목하면 그쪽이 만든 데이터로 읽힌다. 포털 표기가 실제 관계에 가깝다.
     */
    PUBLIC_DATA_PORTAL("공공데이터포털", "전국문화축제표준데이터");
